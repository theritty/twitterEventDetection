...
public class getSpecificTweetList {
    ...
    public static void getSpecificTweets(long round, String word) throws Exception {
        CassandraDao cassandraDao = new CassandraDao("tweets", "counts", "events", "processed");
    ...
    public static void prepareDemo() throws Exception {
        CassandraDao cassandraDao = new CassandraDao("tweets", "counts", "events", "processed");
        CassandraDao cassandraDao2 = new CassandraDao("tweetsdemo", "countsdemo", "eventsdemo", "processeddemo");
        long round = 2034735;
        while(round<=2034751) {
