...
import bolts.CassandraSpoutProcessing.EventDetectorManagerWithCassandraBolt;
import bolts.CassandraSpoutProcessing.EventDetectorWithCassandraBolt;
import bolts.CommonBolts.*;
import bolts.FileSpoutProcessing.EventDetectorBolt;
import bolts.FileSpoutProcessing.EventDetectorManagerBolt;
import bolts.TweetCollection.CassBolt;
import bolts.TweetCollection.DocumentCreator;
import bolts.TweetCollection.PreprocessTweetBolt;
import cass.CassandraDao;
import spout.CassandraSpout;
...
//        DocumentCreator documentCreator = new DocumentCreator(Constants.RESULT_FILE_PATH, FILENUM, TWEET_DOC_CREATION);
    EventDetectorWithCassandraBolt eventDetectorBolt = new EventDetectorWithCassandraBolt(Constants.RESULT_FILE_PATH, FILENUM, TFIDF_EVENT_RATE,
            Integer.parseInt(properties.getProperty("topology.input.file.number")), cassandraDao);
